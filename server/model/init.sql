...
create table companies(
    companies_id BIGSERIAL PRIMARY KEY NOT NULL,
...
create table user_companies(
    fk_companies_id BIGSERIAL PRIMARY KEY NOT NULL,
    fk_user int,
    job_role varchar,
    contribution varchar,
    Begin_Date Date,
    last_Date Date,
    constraint fk_user FOREIGN KEY(fk_user) references users_profile(profile_id) ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_companies_id FOREIGN KEY(fk_companies_id) references companies(companies_id) ON DELETE CASCADE ON UPDATE CASCADE
);
